...
from evaluation.evaluation_retrieval import retrieve_evaluation_chunks
...
def process_evaluation_query(query):
    ...
    # Retrieve relevant chunks from evaluation database
    try:
        results = retrieve_evaluation_chunks(query, k=5)
